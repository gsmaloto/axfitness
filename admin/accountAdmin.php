...
if($date1 >= $date2){
  ...
  You cant generate appointment record in start date is greater than or equal end date!<br>
	...
	$query = "SELECT * FROM `admin` WHERE `created` >= '$date1' AND `created` <= '$date2'
";
...
$pdf->Cell($width_cell[6],10,'Date Registered',1,1,'C',true); 
//// header is over ///////
...
<body>
						...
						<div class="col-12 col-lg-12 col-xxl-9 d-flex">
							<div class="card flex-fill">
								<div class="card-header">
									...
									<a href="accountAdminAdd.php" type="button" class="btn btn-primary mr-auto">Add Admin</a>
								</div>
									...
									<tbody>
										...
										if (mysqli_num_rows($result) == 0) {
											...
											<td class="d-none d-md-table-cell">
												<a class="fa fa-edit pr-3" style="font-size:25px;color:green"  href="accountAdminUpdate.php?id=' . $row['id'] . '"></a>
												<a class="fa fa-trash delete" style="font-size:25px;color:red" href="accountAdminDelete.php?id=' . $row['id'] . '"></a>
											</td>
										</tr>
	...
	<script>
		$('.delete').on('click', function(e) {
			...
			Swal.fire({
				title: 'Are you sure?',
				text: "You want to remove the admin?",
				icon: 'warning',
